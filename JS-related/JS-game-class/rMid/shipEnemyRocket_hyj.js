...
function createRocket_hyj() {
    if(fire_hyj) {
        if(stype_hyj != 2){
            arrRocket_hyj.push({x: sx-66, y: sy - 2, rw: 6, rh: 4, c: "green", v: 7});
        }
        if(stype_hyj === 2){
            arrRocket_hyj.push({x: sx-58, y: sy - 5, rw: 6, rh: 4, c: "green", v: 7});
            arrRocket_hyj.push({x: sx-58, y: sy + 1, rw: 6, rh: 4, c: "green", v: 7});
        }
        if(stype_hyj > 2){
            arrRocket_hyj.push({x: sx-26, y: sy - 15, rw: 6, rh: 4, c: "green", v: 7});
            arrRocket_hyj.push({x: sx-26, y: sy + 11, rw: 6, rh: 4, c: "green", v: 7});
        }
        if(stype_hyj > 3){
            arrRocket_hyj.push({x: sx-16, y: sy + 15, rw: 6, rh: 4, c: "green", v: 7});
            arrRocket_hyj.push({x: sx-16, y: sy - 19, rw: 6, rh: 4, c: "green", v: 7});
        }
    }
}
...
function deleteRocket_hyj() {
    var i;
    for (i = 0; i < arrRocket_hyj.length; i += 1) {
        if(arrRocket_hyj[i].x + arrRocket_hyj[i].rw < 0) {
